...
const variantClasses = {
  default: 'bg-gradient-to-br from-mega-green to-mega-green-dark text-white shadow-lg',
  highlight: 'bg-gradient-to-br from-ball-gold to-amber-500 text-slate-900 shadow-lg shadow-amber-200',
  muted: 'bg-slate-200 text-slate-500',
  selected: 'bg-gradient-to-br from-caixa-blue to-caixa-blue-dark text-white shadow-lg ring-2 ring-caixa-blue-light',
};
...
export function DrawResult({ numbers, size = 'md', animate = false }: DrawResultProps) {
  return (
